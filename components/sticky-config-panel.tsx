...
interface StickyConfigPanelProps {
...
export function StickyConfigPanel({
  onApplyConfig,
  currentConfig,
  visible,
  onVisibilityChange,
}: StickyConfigPanelProps) {
  ...
  return (
    <div className="sticky-config-panel h-full overflow-auto border-l bg-background p-4 w-[400px]">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold">View Configuration</h3>
        <Button
          variant="ghost"
          size="icon"
      ...
      <Textarea
        ...
        className="font-mono h-[calc(100vh-300px)] resize-none mb-4"
        placeholder={`{
  "id": "custom-view",
  "label": "Custom View",
  "icon": "dollar",
